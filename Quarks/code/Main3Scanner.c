...
/* External objects */
extern q_int line; /* Source code line numbers - defined in scanner.c */
 ...
 * -------------------------------------------------------------
 */
q_void printScannerError(q_str fmt, ...);
q_void displayScanner(BufferPointer ptrBuffer);
q_long getScannerFilesize(q_str fname);
