...
#include <stdlib.h> /* for dynamic memory allocation */ /* for dynamic memory allocation*/
...
#define READER_MAX_SIZE		2048		/* maximum capacity */ 

#define READER_DEFAULT_SIZE	128			/* default initial buffer reader capacity */
